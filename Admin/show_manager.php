            ...
            <div class="box box-info">
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php
                        $i=0;
                        $statement = $pdo->prepare("SELECT * FROM Manager order by mid ASC");
                        $statement->execute();
                        ...
                        foreach ($result as $row) {
                            ...
                            <tr>
                                ...
                                <!--                                </td>-->
                                <td>
                                    <a href="#" class="btn btn-danger btn-xs" data-href="customer-delete.php?id=<?php echo $row['mid']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
